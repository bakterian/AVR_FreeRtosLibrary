 ...
 *
 * MK: Added definitions for the ATMEGA
 * MK: TODO: Remove dependency on this header
...
/*-----------------------------------------------------------*/
/* In case of very basic MEGA MCU use the following macro  */
/* Extend the condition statement */
#ifdef __AVR_ATmega32__
#ifndef ATMEGA_DEFAULT
#define	ATMEGA_DEFAULT
#endif
#endif
/*-----------------------------------------------------------*/

/*-----------------------------------------------------------*/
/* In order to add extra trace information uncomment the define*/
/* Extend the condition statement */
#define __AVR_DEBUG__
/*-----------------------------------------------------------*/
...
// Atmega I/O MCU Compatible notation.
#ifndef _MEGA_
	#define _MEGA_
#endif
...
/* Watchdog period options: 	WDTO_15MS, WDTO_30MS, WDTO_60MS, WDTO_120MS, WDTO_250MS, WDTO_500MS */
...
/**
 * Select WIZCHIP (TCP/IP embedded Ethernet controller)..
...
// GoldiLocks Project I/O MCU Compatible notation.
#ifndef _GOLDILOCKS_
	#define _GOLDILOCKS_
#endif
...
// Arduino Uno I/O MCU (with USB Bootloader) Compatible notation.
#ifndef _U2DUINO_
	#define _U2DUINO_
#endif
...
#elif defined (portUSE_TIMER0) || defined (portUSE_TIMER1)
//#define configTICK_RATE_HZ			( (TickType_t) 125 )        // Using 200Hz to get system tick of 8 ms
#define configTICK_RATE_HZ			( (TickType_t) 200 )        // Using 200Hz to get system tick of 5 ms
//#define configTICK_RATE_HZ			( (TickType_t) 500 )          	// Using 500Hz to get a system tick of 2 ms
#endif
...
#define SPI_BIT_SS_WIZNET	_BV(PA5)	// added for Wiznet 5100/5200 support with SS

#define SPI_PORT_SS_G2		PORTA
#define SPI_PORT_DIR_SS_G2	DDRA
#define SPI_PORT_PIN_SS_G2	PINA
#define SPI_BIT_SS_G2		_BV(PA6)	// added to for Gameduino2 using FTDI FT800 Graphics

#define SPI_PORT_SS_SD		PORTA
#define SPI_PORT_DIR_SS_SD	DDRA
#define SPI_PORT_PIN_SS_SD	PINA
#define SPI_BIT_SS_SD		_BV(PA7)	// added for SD Card support with SS
/* defined(_MEGA_) */
